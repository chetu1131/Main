...
CREATE TABLE
  `ResultMaster` (
    ...
    KEY `ExamID` (`ExamID`),
    CONSTRAINT `ResultMaster_ibfk_1` FOREIGN KEY (`StudentID`) REFERENCES `StudentMaster` (`StudentID`),
    CONSTRAINT `ResultMaster_ibfk_2` FOREIGN KEY (`SubjectID`) REFERENCES `SubjectMaster` (`SubjectID`),
    CONSTRAINT `ResultMaster_ibfk_3` FOREIGN KEY (`ExamID`) REFERENCES `ExamMaster` (`ExamID`)
